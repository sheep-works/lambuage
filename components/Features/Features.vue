<template>
    <v-container fluid>
        <FeatureCard v-for="ft in myFeatures" :position="ft.position" :src="ft.src" :title="ft.title" :link="ft.link">
            <div v-html="ft.content.replaceAll('\n', '<br />')" />
        </FeatureCard>
    </v-container>
</template>
...
const myFeatures: Feature[] = [
    {
        position: "right",
        src: "/pict/calender.jpg",
        title: "翻訳のディレクション＆スケジューリング",
        content: `
